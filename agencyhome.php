...
<div class="container">
  <div class="btn-group">
    ...
    <button type="button" class="btn btn-primary">ON GOING</button>
				    ...
				    <li>
					    <img alt="My 24th Birthday!" src="https://farm5.staticflickr.com/4150/5045502202_1d867c8a41_q.jpg">
					    	<div class="info">
			    				...
			    				<h2 class="title">Pot holes</h2>
			    				<p class="desc">Several pot holes needs repair in the area.</p>
			    				<ul>
			    					<li style="width:33%;">1 <span class="glyphicon glyphicon-ok"></span></li>
			    					<li style="width:34%;">Current Status</li>
			    				    <li style="width:33%;">Location</li>
				    			</ul>
				    		</div>
					</li>
					<li>
