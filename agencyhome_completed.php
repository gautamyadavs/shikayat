<?php
    ...
    if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1){
        ...
        if(!$db){
					...
					<div class="container">
						...
						<div class="mbr-table">
							...
							<div class="mbr-table-cell">
								...
								<ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar"><li class="nav-item"><a class="nav-link link" href="agencyhome.html">complain</a></li><li class="nav-item"><a class="nav-link link" href="agencyworkmen.html">workmen</a></li><li class="nav-item"><a class="nav-link link" href="#">profile</a></li><li class="nav-item"><a class="nav-link link" href="logout.php"><p>logout</p></a></li></ul>
			...
			<section class="engine"><a rel="external" href="#"></a></section><section class="mbr-section mbr-parallax-background mbr-after-navbar" id="content5-l" style="background-image: url(assets/images/desert2.jpg); padding-top: 120px; padding-bottom: 120px;">
