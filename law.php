...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <option value="Transformer Short">1. Transformer Short</option>
    <option value="Loudspeakers between 10.00 p.m. to 6.00 a.m.">2. High tension line too low</option>
    <option value="Electricity absent">3. Electricity absent</option>
    <option value=" Electricity Theft">4. Electricity Theft</option>
    </div>
</div>
  <br><br>
