...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <option value="Street lights not working">1. Street lights not working</option>
    <option value="Street lights missing">2. Street lights missing</option>
    <option value="Inappropriate behaviour of workers">3. Inappropriate behaviour of workers</option>
    <option value="Encroachment of Road">4. Encroachment of Road</option>
	<option value="Speed breaker construction">5. Speed breaker construction</option>
    <option value="Road repair">6. Road repair</option>
    <option value="Broken Divider">7. Broken Divider</option>
    <option value="Divider Missing">8. Divider Missing</option>
	<option value="Construction of Road">9. Construction of Road</option>
    <option value="Road Sign Missing">10. Road Sign Missing</option>
    <option value="Road Sign Repair">11. Road Sign Repair</option>
    <option value="No Parking Spot">12. No Parking Spot</option>
	<option value="False Parking ticket">13. False Parking ticket</option>
    <option value="Distressed bridge">14. Distressed bridge</option>
    <option value="Lack of basic amenities">15. Lack of basic amenities</option>
    <option value="Other complaints">16. Other complaints*</option>
  </select>
    </div>
</div>
  <br><br>
