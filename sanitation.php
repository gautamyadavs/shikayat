...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <option value="Municipal Corporation Dead Animal Removal">1. Municipal Corporation Dead Animal Removal</option>
    <option value="Cleanliness of Public Restroom">2. Cleanliness of Public Restroom</option>
    <option value="Garbage Pickup">3. Garbage Pickup</option>
    <option value="Garbage Can Repair">4. Garbage Can Repair</option>
	<option value="Plumbing problems in public restroom">5. Plumbing problems in public restroom</option>
    <option value="Cleaning of chocked sewer lines">6. Cleaning of chocked sewer lines</option>
    <option value="Road sweeping">7. Road sweeping</option>
    <option value="DFacilities Not Available">8. Facilities Not Available</option>
	<option value="Garbage Dumping in Non Rubbish Points">9. Garbage Dumping in Non Rubbish Points</option>
    <option value="Inappropriate behaviour of workers">10. Inappropriate behaviour of workers</option>
  </select>
    </div>
</div>
  <br><br>
