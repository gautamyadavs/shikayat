<?php
    ...
    if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1){
        ...
        if(!$db){
			...
			<section class="mbr-section mbr-parallax-background mbr-after-navbar" id="content5-l" style="background-image: url(assets/images/desert2.jpg); padding-top: 120px; padding-bottom: 120px;">
